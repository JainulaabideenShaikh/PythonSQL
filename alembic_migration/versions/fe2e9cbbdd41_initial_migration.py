...
Revision ID: fe2e9cbbdd41
Revises: 
Create Date: 2025-09-24 10:25:04.337321
...
def upgrade() -> None:
    ...
    op.drop_table('loans')
    op.drop_table('task3app_product')
    op.drop_table('busapp_bus')
...
def downgrade() -> None:
    ...
    op.create_table('busapp_bus',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    sa.Column('bus_name', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    sa.Column('starting_pt', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    sa.Column('ending_pt', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    sa.Column('time', postgresql.TIME(), autoincrement=False, nullable=False),
    sa.Column('no_of_seats', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('price', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('type_of_bus', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    sa.CheckConstraint('no_of_seats >= 0', name=op.f('busapp_bus_no_of_seats_check')),
    sa.CheckConstraint('price >= 0', name=op.f('busapp_bus_price_check')),
    sa.PrimaryKeyConstraint('id', name=op.f('busapp_bus_pkey'))
    )
    op.create_table('task3app_product',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    sa.Column('product_name', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('product_category', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('task3app_product_pkey'))
    )
    op.create_table('loans',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('book_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('borrower', sa.TEXT(), autoincrement=False, nullable=False),
    ...
    op.create_table('empapp_employee',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    sa.Column('age', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('sal', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('address', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    sa.CheckConstraint('age >= 0', name=op.f('empapp_employee_age_check')),
    sa.PrimaryKeyConstraint('id', name=op.f('empapp_employee_pkey'))
    )
